...
namespace SARSCOV2.Controllers
{
    public class WojZgonyAllController : Controller
    {
        ...
        {
            string query = "SELECT stan_rekordu_na, zgony_w_wyniku_covid_bez_chorob_wspolistniejacych, zgony_w_wyniku_covid_i_chorob_wspolistniejacych FROM WojZgonyAllView WHERE wojewodztwo=@wojewodztwo";
